...
class StaffControllerIntegrationTest {
    ...
    private String payload() {
        return "{\"firstName\":\"test-security\",\"lastName\":\"test-security\",\"email\":\"test@example.com\",\"phone\":\"+1-555-0100\",\"role\":\"HOUSEKEEPER\",\"status\":\"ACTIVE\"}";
    }
    ...
    void should_return_200_when_entity_exists_by_id() throws Exception {
        String location = mockMvc.perform(post("/api/v1/staffs")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(payload()))
                .andExpect(status().isCreated())
        ...
        mockMvc.perform(get(location))
                ...
                .andExpect(jsonPath("$.firstName").value("test-security"))
                .andExpect(jsonPath("$.lastName").value("test-security"))
    ...
    void should_return_404_when_entity_is_not_found_by_id() throws Exception {
        mockMvc.perform(get("/api/v1/staffs/{id}", "00000000-0000-0000-0000-000000000000"))
    ...
    void should_return_400_when_id_format_is_invalid() throws Exception {
        mockMvc.perform(get("/api/v1/staffs/{id}", "not-a-valid-uuid"))
    ...
    void should_return_400_when_create_request_has_blank_string_fields() throws Exception {
        mockMvc.perform(post("/api/v1/staffs")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"firstName\":\"\",\"lastName\":\"\",\"email\":\"\",\"phone\":\"\",\"role\":\"\",\"status\":\"\"}"))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.status").value(400));
    }
    ...
    void should_return_404_when_updating_non_existent_entity() throws Exception {
        mockMvc.perform(put("/api/v1/staffs/{id}", "00000000-0000-0000-0000-000000000000")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(payload()))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.status").value(404));
    ...
    void should_return_404_when_deleting_non_existent_entity() throws Exception {
        mockMvc.perform(delete("/api/v1/staffs/{id}", "00000000-0000-0000-0000-000000000000"))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.status").value(404));
    }
    ...
    @Test
    @WithMockUser(roles = {"ADMIN"})
    void should_return_409_when_create_request_has_duplicate_unique_field() throws Exception {
        mockMvc.perform(post("/api/v1/staffs")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(payload()))
                .andExpect(status().isCreated());
