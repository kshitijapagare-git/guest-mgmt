...
class HousekeepingTaskRepositoryTest {
    ...
    private HousekeepingTask newEntity(int seed) {
    ...
    void should_persist_entity_and_assign_id_when_saved() {
        HousekeepingTask saved = repository.save(newEntity(0));
    ...
    void should_return_all_entities_when_repository_is_queried() {
        ...
        Page<HousekeepingTask> page = repository.findAll((Specification<HousekeepingTask>) null, PageRequest.of(0, 20));
    ...
    void should_filter_results_when_specification_is_provided() {
        repository.save(newEntity(0));
        repository.save(newEntity(1));
        Specification<HousekeepingTask> matchNone = (root, query, cb) -> cb.disjunction();
        Page<HousekeepingTask> page = repository.findAll(matchNone, PageRequest.of(0, 20));
