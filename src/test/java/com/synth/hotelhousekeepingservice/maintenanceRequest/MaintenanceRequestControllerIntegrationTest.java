...
class MaintenanceRequestControllerIntegrationTest {
    ...
    @Autowired MaintenanceRequestRepository repository;
    ...
    void setUp() throws Exception {
        jdbcTemplate.execute("TRUNCATE TABLE maintenance_requests CASCADE");
    ...
    void should_return_200_when_entity_exists_by_id() throws Exception {
        String location = mockMvc.perform(post("/api/v1/maintenance-requests")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(payload()))
                .andExpect(status().isCreated())
                .andReturn().getResponse().getHeader("Location");
        ...
        mockMvc.perform(get(location))
                ...
                .andExpect(jsonPath("$.reportedByGuestId").value("00000000-0000-0000-0000-000000000001"))
                .andExpect(jsonPath("$.issueType").value("PLUMBING"))
                .andExpect(jsonPath("$.description").value("test-security"))
    ...
    void should_return_404_when_entity_is_not_found_by_id() throws Exception {
        mockMvc.perform(get("/api/v1/maintenance-requests/{id}", "00000000-0000-0000-0000-000000000000"))
    ...
    void should_return_400_when_id_format_is_invalid() throws Exception {
        mockMvc.perform(get("/api/v1/maintenance-requests/{id}", "not-a-valid-uuid"))
    ...
    void should_return_400_when_create_request_has_blank_string_fields() throws Exception {
        mockMvc.perform(post("/api/v1/maintenance-requests")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"hotelId\":\"00000000-0000-0000-0000-000000000000\",\"roomId\":\"00000000-0000-0000-0000-000000000000\",\"reportedByGuestId\":\"00000000-0000-0000-0000-000000000000\",\"issueType\":\"\",\"description\":\"\",\"priority\":\"\",\"status\":\"\",\"estimatedCost\":0.0,\"resolvedAt\":\"\"}"))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.status").value(400));
    }
    ...
    void should_return_404_when_updating_non_existent_entity() throws Exception {
        mockMvc.perform(put("/api/v1/maintenance-requests/{id}", "00000000-0000-0000-0000-000000000000")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(payload()))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.status").value(404));
    ...
    void should_return_404_when_deleting_non_existent_entity() throws Exception {
        mockMvc.perform(delete("/api/v1/maintenance-requests/{id}", "00000000-0000-0000-0000-000000000000"))
                .andExpect(status().isNotFound())
                .andExpect(jsonPath("$.status").value(404));
    }
